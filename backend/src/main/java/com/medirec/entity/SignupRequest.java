...
public class SignupRequest {
    ...
    // Essential Information from DTO
    @Column(nullable = false)
    private String fullName; // Renamed from name

    @Column(nullable = false, unique = true) // Consider if unique constraint should be here or handled by service
    private String email;

    @Column(nullable = false)
    private String password; // Storing hashed password, or plain if it's just for admin review before user creation
    ...
    private boolean twoFactorPreference;
